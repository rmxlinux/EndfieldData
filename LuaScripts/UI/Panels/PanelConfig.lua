...
config = {
    ...
    ActivityLimitedFormulaAssistRegionV2 = {
        folder = "Activity",
        orderType = Types.EPanelOrderTypes.Window,
        clearedPanel = true,
        closeWhenChangeScene = true,
    ...
    TyphoeaArcherySimulateTrain = {
        folder = "TyphoeaArchery",
        orderType = Types.EPanelOrderTypes.Window,
        clearedPanel = true,
        closeWhenChangeScene = true,
        preserveWhenChangeLanguage = false,
    ...
    WulingParkourChallengeGoalPopup = {
        folder = "WulingParkour",
        orderType = Types.EPanelOrderTypes.Window,
        clearedPanel = true,
        closeWhenChangeScene = true,
